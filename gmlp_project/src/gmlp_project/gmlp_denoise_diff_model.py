...
- Diff-mode: A/B は異なる初期化シードを持ち、同一ミニバッチ順で学習
...
# ----------------- argparse -----------------
def build_args():
    p = argparse.ArgumentParser("gMLP+SGU dual-model denoising experiment")
    p.add_argument(
        "--input",
        type=str,
    ...
    p.add_argument("--output_dir", type=str, default="/sqfs/work/cm9029/${USER_ID}/gmlp_output/denoise_diff_model")
...
def main():
    ...
    run_name = f"run_gmlp_denoise_diff_{ts}_p{args.patch}_{args.measure_data}"
