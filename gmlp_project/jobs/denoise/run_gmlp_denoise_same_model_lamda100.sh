...
#PBS -l gpunum_job=2
#PBS -o ../gmlp_logs/gmlp_denoise_same_model.out
#PBS -e ../gmlp_logs/gmlp_denoise_same_model.err
#PBS -r n
...
BATCH="${BATCH:-256}"
LR="${LR:-1e-3}"
INPUT="${INPUT:-/sqfs/work/cm9029/${USER_ID}/gmlp_project/data/denoise/mnist_lambda100.npz}"
OUTDIR="${OUTDIR:-/sqfs/work/cm9029/${USER_ID}/gmlp_output/denoise_same_model/lambda100}"
