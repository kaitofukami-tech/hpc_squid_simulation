...
#PBS -l gpunum_job=2
#PBS -o ../gmlp_logs/gmlp_denoise_diff_model_lambda500.out
#PBS -e ../gmlp_logs/gmlp_denoise_diff_model_lambda500.err
#PBS -r n
...
OUTDIR="${OUTDIR:-/sqfs/work/cm9029/${USER_ID}/gmlp_output/denoise_diff_model/lambda500}"
