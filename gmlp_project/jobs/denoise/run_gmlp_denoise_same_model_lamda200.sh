...
BATCH="${BATCH:-256}"
LR="${LR:-1e-3}"
INPUT="${INPUT:-/sqfs/work/cm9029/${USER_ID}/gmlp_project/data/denoise/mnist_lambda200.npz}"
OUTDIR="${OUTDIR:-/sqfs/work/cm9029/${USER_ID}/gmlp_output/denoise_same_model/lambda200}"
