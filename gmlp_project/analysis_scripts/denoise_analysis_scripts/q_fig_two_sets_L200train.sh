...
CMD=(python "${REPO_ROOT}/analysis_scripts/qinv_calc_fig_two_sets.py" \
  --spin_file_a1 ${MONO_ROOT}/gmlp_output/denoise_diff_model/lambda200/run_gmlp_denoise_diff_20260101-131011_p4_train/gmlp_spinA_train_D256_F1536_L10_M1000_seedA123.pkl\
  --spin_file_b1 ${MONO_ROOT}/gmlp_output/denoise_diff_model/lambda200/run_gmlp_denoise_diff_20260101-131011_p4_train/gmlp_spinB_train_D256_F1536_L10_M1000_seedB456.pkl\
  ${METRICS_A1:+--metrics_a1 "$METRICS_A1"} \
  ${METRICS_B1:+--metrics_b1 "$METRICS_B1"} \
  --label1       GMLP_p4_MNIST_DIFF_train \
  --spin_file_a2  ${MONO_ROOT}/gmlp_output/denoise_same_model/lambda200/run_gmlp_denoise_same_20260101-141906_p4_train/gmlp_same_spinA_train_D256_F1536_L10_M1000_seed123_trA2025.pkl\
  --spin_file_b2  ${MONO_ROOT}/gmlp_output/denoise_same_model/lambda200/run_gmlp_denoise_same_20260101-141906_p4_train/gmlp_same_spinB_train_D256_F1536_L10_M1000_seed123_trB4242.pkl\
