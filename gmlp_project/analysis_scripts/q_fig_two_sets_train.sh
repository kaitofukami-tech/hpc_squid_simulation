...
OUTDIR="${OUTDIR:-${REPO_ROOT}/test/class_diff}"
...
CMD=(python "${REPO_ROOT}/analysis_scripts/qinv_calc_fig_two_sets.py" \
  --spin_file_a1 /sqfs/work/cm9029/${USER_ID}/gmlp_output/diff_model/run_gmlp_20260101-020554_p4_train/gmlp_spinA_train_D256_F1536_L10_M1000_seedA123.pkl\
  --spin_file_b1 /sqfs/work/cm9029/${USER_ID}/gmlp_output/diff_model/run_gmlp_20260101-020554_p4_train/gmlp_spinB_train_D256_F1536_L10_M1000_seedB456.pkl\
  ${METRICS_A1:+--metrics_a1 "$METRICS_A1"} \
  ${METRICS_B1:+--metrics_b1 "$METRICS_B1"} \
  --label1       GMLP_p4_diff \
  --spin_file_a2  /sqfs/work/cm9029/${USER_ID}/gmlp_output/same_model/run_gmlp_same_20260101-020554_p4_train/gmlp_same_model_spinA_train_D256_F1536_L10_M1000_seed123_trA2025.pkl\
  --spin_file_b2  /sqfs/work/cm9029/${USER_ID}/gmlp_output/same_model/run_gmlp_same_20260101-020554_p4_train/gmlp_same_model_spinB_train_D256_F1536_L10_M1000_seed123_trB4242.pkl\
