...
SPIN_A1="${SPIN_A1:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_1sent/first_sent_train_spinA.pkl}"
SPIN_B1="${SPIN_B1:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_1sent/first_sent_train_spinB.pkl}"
SPIN_A2="${SPIN_A2:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_100sent/100_sent_train_spinA.pkl}"
SPIN_B2="${SPIN_B2:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_100sent/100_sent_train_spinB.pkl}"
