...
#PBS -o ~/mlp_overlap_layer_profile_diff_train.out
#PBS -e ~/mlp_overlap_layer_profile_diff_train.err
#PBS -r n

set -euo pipefail

echo "🚀 Starting MLP MLM overlap layer-profile job (diff train)"
...
SPIN_A1="${SPIN_A1:-/sqfs/work/cm9029/${USER_ID}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_1sent/first_sent_train_spinA.pkl}"
SPIN_B1="${SPIN_B1:-/sqfs/work/cm9029/${USER_ID}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_1sent/first_sent_train_spinB.pkl}"
SPIN_A2="${SPIN_A2:-/sqfs/work/cm9029/${USER_ID}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_100sent/100_sent_train_spinA.pkl}"
SPIN_B2="${SPIN_B2:-/sqfs/work/cm9029/${USER_ID}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-031304_diff_seq128_train_100sent/100_sent_train_spinB.pkl}"
EPOCHS="${EPOCHS:-1 94 484 727 1000}"
DEFAULT_OUTPUT="$REPO_ROOT/batchnorm/mlp_mlm_qinv_out/manifold1_100/diff_train_overlap_layer_profile_100.png"
OUTPUT="${OUTPUT:-$DEFAULT_OUTPUT}"
DEFAULT_OUTPUT_CSV="$REPO_ROOT/batchnorm/mlp_mlm_qinv_out/manifold1_100/diff_train_overlap_layer_profile_100.csv"
...
TITLE="${TITLE:-Overlap metrics vs layer (MLP MLM)}"
