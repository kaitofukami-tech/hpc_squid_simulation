...
SPIN_A1="${SPIN_A1:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-135707_same_seq128_val_1sent/first_sent_val_spinA.pkl}"
SPIN_B1="${SPIN_B1:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-135707_same_seq128_val_1sent/first_sent_val_spinB.pkl}"
SPIN_A2="${SPIN_A2:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-135707_same_seq128_val_100sent/100_sent_val_spinA.pkl}"
SPIN_B2="${SPIN_B2:-${MONO_ROOT}/mlp_output/mlp_mlm/manifold100/recompute_run_20260126-135707_same_seq128_val_100sent/100_sent_val_spinB.pkl}"
